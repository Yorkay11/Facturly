...
export default function Stepper({
  ...
  // Utiliser l'étape contrôlée si fournie, sinon l'état interne
  ...
  const handleNext = async () => {
    if (!isLastStep) {
      // Appeler onStepChange pour validation avant de mettre à jour
          ...
          <div className={`stepper-footer-container ${footerClassName}`}>
            <div className={`stepper-footer-nav ${currentStep !== 1 ? 'spread' : 'end'}`}>
              ...
              <button 
                ...
                {...(Object.fromEntries(Object.entries(nextButtonProps).filter(([key]) => key !== 'onClick')))}
              >
