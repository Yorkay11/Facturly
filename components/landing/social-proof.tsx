...
export function SocialProof() {
  ...
  return (
    <section className="self-stretch py-12 md:py-16 flex flex-col justify-center items-center gap-8 md:gap-12 overflow-hidden px-4 bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full max-w-6xl">
        {stats.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className="group flex flex-col items-center gap-3 p-6 md:p-8 rounded-xl bg-card border border-border hover:border-primary/40 hover:shadow-lg transition-all duration-300"
            >
