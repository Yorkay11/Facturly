  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        >
          <img src="/logos/icon.png" alt="Facturly" className="h-16 w-16 object-contain grayscale" />
        </div>
      </div>
      <motion.div
        style={{
      ...
      >
        <div className="absolute inset-0 rounded-lg bg-[#272729] [transform:translateZ(0)]" />
        <img
          src={src as string}
...
export const KBtn = ({
  ...
  return (
    <div
      className={cn(
        "rounded-[4px] p-[0.5px] [transform:translateZ(0)]",
