...
export function CTASection() {
  ...
  return (
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      <div className="absolute inset-0 top-[-90px] z-0">
        <svg
      ...
      <div className="relative z-20 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        ...
        <Link href={buttonHref} onClick={handleClick}>
          <Button
            className="px-[30px] py-2 bg-secondary text-secondary-foreground text-base font-medium leading-6 rounded-full shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:bg-secondary/90 transition-all duration-200"
            size="lg"
          >
            {buttonText}
          </Button>
