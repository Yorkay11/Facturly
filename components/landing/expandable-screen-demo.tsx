    ...
    >
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-20">
        <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 text-center">
          ...
          <ExpandableScreenTrigger>
            <div className="bg-primary h-15 px-6 sm:px-8 py-3 text-lg sm:text-xl font-regular text-primary-foreground tracking-[-0.01em] cursor-pointer">
              Get early access
            </div>
          </ExpandableScreenTrigger>
        </div>
            ...
            <form className="space-y-4 sm:space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg bg-card border-0 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-foreground/20 transition-all resize-none text-sm h-10"
                  />
                </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-card border-0 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-foreground/20 transition-all resize-none text-sm"
                />
              </div>
              <Button
                type="submit"
